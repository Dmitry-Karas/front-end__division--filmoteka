...
async function onAuthModalOpen(e) {
  ...
  console.log('~ authModal', authModal.title);
  console.log('~ authFormEmailInput', authFormEmailInput.value);
  console.log('~ authFormPasswordInput', authFormPasswordInput.value);
...
function windowHandler(e) {
  ...
  authModal.title === 'Sign in'
    ? (authModal.title = 'Registration')
    : (authModal.title = 'Sign in');
  console.log(authModal.title);
