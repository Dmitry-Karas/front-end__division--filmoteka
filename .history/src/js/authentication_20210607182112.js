...
async function onAuthModalOpen(e) {
  ...
  window.addEventListener('click', async e => {
    ...
    let authModalTitle = document.querySelector('.auth-modal__title');
    let authModalConfirmBtn = document.querySelector('.auth-modal__button');
    let authFormText = document.querySelector('.auth-form__text');
    let authFormBtn = document.querySelector('.auth-form__button');

    if (authModalTitle.textContent !== 'Registration') {
      authModalTitle === 'Sign in'
        ? (authModalTitle = 'Registration')
        : (authModalTitle = 'Sign in');
      ...
      authFormBtn.textContent === 'Sign in!'
        ...
        : (authFormBtn.textContent = 'Sign in!');
      console.log('~ authModalTitle', authModal.title);
